...
main = function(index){
  ...
  #print(alphabets)
  xpaths = paste("//a[@name='DERIVED_SSS_BCC_SSR_ALPHANUM_", alphabets, "']/attribute::href", sep="")
  #print(xpaths)
  codes = c()
  #courses = c()
  course_info = list()
...
clusterExport(cl, list("getNodeSet", "htmlTreeParse", "POST", "GET", "xmlValue", "xmlAttrs"))
parLapply(cl, 1:core_num, fun=main)
stopCluster(cl)

b = toJSON(course_info, pretty = TRUE)
write(b, "/Users/yingbozhang/Desktop/myproj/rproj/test.json")
